...
?>
	<head>
		...
		<title><?php echo $music_list['title']?></title>
	...
	<body id="body">
		...
		<div >
			...
			<div class="musicName">
				<!--<span>慌しく年</span>-->
				<span style="color: <?php echo $music_list['color3']?>"><?php echo $music_list['song']?></span>
				<!--<span>Kiroro-好きな人</span>-->
			</div>
			<!--歌词-->
			<div id="musicContent">
				<span class="musicContent01" style="color:<?php echo $music_list['color1']?>"></span>
				<span class="musicContent02" style="color:<?php echo $music_list['color2']?>"></span>
				<span class="musicContent03" style="color:<?php echo $music_list['color1']?>"></span>
			</div>
			<!-- 弹幕内容 -->
			<div class="danmu_txt">
        ...
        return $str; 
			        ...
			        $sql = 'select *from music where id='.$id ;
			         ...
			         if(find($sql)){
			            ...
			            foreach($comment_list as $k=>$v){
			            	...
			            	echo '<div class="box" style="background-color:'.randomColor().';max-width:'.rand(70, 100).'%"><img src="'.$music_list['image'].'" class="touxiang" onerror="this.style.display='."'none'".'"><div class="content" style="color:'."#white".'">'.$v['content'].'</div></div>';	
			            }
			...
			<div class="now_geci" style="text-align:center; "><span class="musicContent02" style="font-size: 18px;visibility:hidden;color:<?php echo $music_list['color2']?>" id="now_geci" ></span>  </div> <!-- 当前歌词 -->
